<template>
    <div>
        ...
        <div class="lg:mt-[73px] mt-[97px]">
            ...
            <div class="flex flex-col lg:flex-row lg:mt-[60px] mx-[15px] lg:mx-[40px]">
...
export default {
    ...
    computed: {
        activeLink() {
            return customerServicesData.filter((e) => e.path === this.$route.path)[0].name
        },
    },
    mounted() {
        console.log(this.activeLink);
    },
    components: { CustomerBanner }
}
</script>
